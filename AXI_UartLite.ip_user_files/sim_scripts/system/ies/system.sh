...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../AXI_UartLite.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../AXI_UartLite.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" \
       +incdir+"$ref_dir/../../../../AXI_UartLite.srcs/sources_1/bd/system/ipshared/1313/hdl" \
       +incdir+"../../../../AXI_UartLite.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../AXI_UartLite.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" \
       +incdir+"../../../../AXI_UartLite.srcs/sources_1/bd/system/ipshared/1313/hdl" \
